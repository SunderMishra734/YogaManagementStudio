...
namespace View.Controllers
{
    public class ClassController : Controller
    {
        ...
        public ClassController()
        {
            ...
            apiUrl = "https://localhost:7243/api/class";
            studyingClassApiUrl = "https://localhost:7243/api/Class/studyclass";
            changeClassApi = "https://localhost:7243/api/Class/changeclasses";
            changeClassApi2 = "https://localhost:7243/api/Class/changeclass";
            enrollClassApiUrl = "https://localhost:7243/api/Class/enroll";
            teachingClassApiUrl = "https://localhost:7243/api/Class/teachclass";
            availableDateApiUrl = "https://localhost:7243/api/Class/availabledate";
            slotApiUrl = "https://localhost:7243/api/Class/slot";
        }
