...
namespace View.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController()
        {
            ...
            apiUrl = "https://localhost:7243/api/user";
            classApiUrl = "https://localhost:7243/api/class";
            studySlotApiUrl = "https://localhost:7243/api/Class/slot";
            changeClassRequestsApiUrl = "https://localhost:7243/api/Class/changeclass";
        }
        ...
        {
            var signup = "https://localhost:7243/api/auth/signup/" + signupDto.Role;
